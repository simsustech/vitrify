...
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/plugins/postcss.mjs
...
function Kc(t, e, s) {
	...
	switch (r.type) {
		...
		case "selector-combinator":
			...
			return [r.value.trimStart().startsWith("(") ? A : "", Te(V(r.value.trim(), e)) || A];
		...
		var Vi = Yi(), zi = ds(), ot = class t extends Error {
			...
			showSourceCode(e) {
				...
				return o.slice(u, a).map((f, h) => {
					...
					if (l === this.line) {
						if (f.length > 160) {
							let m = 20, p = Math.max(0, this.column - m), y = Math.max(this.column + m, this.endColumn + m), g = f.slice(p, y), v = r(d.replace(/\d/g, " ")) + f.slice(0, Math.min(this.column - 1, 19)).replace(/[^\t]/g, " ");
							return n(">") + r(d) + i(g) + `
 ` + v + n("^");
						}
			...
			function se(k) {
				...
				switch (i = r.charCodeAt(p), i) {
					...
					case 92:
						...
						break;
					default: i === 47 && r.charCodeAt(p + 1) === 42 ? (a = r.indexOf("*/", p + 2) + 1, a === 0 && (n || b ? a = r.length : q("comment")), f = [
						"comment",
						r.slice(p, a + 1),
						p,
						a
			...
			function se(k) {
				...
				switch (i = r.charCodeAt(m), i) {
					...
					case 92:
						...
						break;
					default: l = r.charCodeAt(m + 1), i === 35 && l === 123 ? (o = m, W(), a = r.slice(m, o + 1), d = [
						"word",
						a,
						m,
						o
			...
			for (var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, c = void 0, f = void 0, h = void 0, l = void 0, d = void 0, x = s.length, m = -1, p = 1, y = 0, g = function(C, q) {
				...
				switch (r = s.charCodeAt(y), r === St && (m = y, p += 1), r) {
					...
					case Xs:
						...
						break;
					default: r === xu && s.charCodeAt(y + 1) === Tu ? (n = s.indexOf("*/", y + 2) + 1, n === 0 && g("comment", "*/"), a = s.slice(y, n + 1), o = a.split(`
			...
			for (; a < i;) {
				switch (h = n.charCodeAt(a), h === 10 && (o = a, u += 1), h) {
					...
					case 42:
						...
						break;
					default: if (h === 47 && (n.charCodeAt(a + 1) === 42 || s.loose && !f && n.charCodeAt(a + 1) === 47)) {

...
export default interface ICanvasAdapter {
     ...
     */
    getContext(caller: ICanvasAdapterCaller, contextType: string, contextAttributes?: Record<string, unknown>): ICanvasRenderingContext2D | null;
    /**
     ...
     */
    toBlob(caller: ICanvasAdapterCaller, callback: (blob: Blob | null) => void, type?: string, quality?: unknown): void;
}
//# sourceMappingURL=ICanvasAdapter.d.ts.map
...
const propertyMap = new Map([
    ...
    [
        'animation',
        val => { var _a; return ((_a = { 'none': 'animate-none' }[val]) !== null && _a !== void 0 ? _a : `animate-[${getCustomVal(val)}]`); }
    ],
    [
        'animation-delay',
    ...
    [
        'appearance',
        val => { var _a; return ((_a = { 'none': 'appearance-none' }[val]) !== null && _a !== void 0 ? _a : `[appearance:${getCustomVal(val)}]`); }
    ],
    [
        'aspect-ratio',
    ...
    [
        ...
        val => {
            ...
            const backdropFilterValConfig = {
                blur: (v) => { var _a, _b; return `backdrop-blur-${(_b = (_a = customTheme["backdrop-blur"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                brightness: (v) => { var _a, _b; return `backdrop-brightness-${(_b = (_a = customTheme["backdrop-brightness"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                contrast: (v) => { var _a, _b; return `backdrop-contrast-${(_b = (_a = customTheme["backdrop-contrast"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                grayscale: (v) => { var _a, _b; return `backdrop-grayscale-${(_b = (_a = customTheme["backdrop-grayscale"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                'hue-rotate': (v) => {
                    var _a, _b;
                ...
                invert: (v) => { var _a, _b; return `backdrop-invert-${(_b = (_a = customTheme["backdrop-invert"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                opacity: (v) => { var _a, _b; return `backdrop-opacity-${(_b = (_a = customTheme["backdrop-opacity"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                saturate: (v) => { var _a, _b; return `backdrop-saturate-${(_b = (_a = customTheme["backdrop-saturate"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                sepia: (v) => { var _a, _b; return `backdrop-sepia-${(_b = (_a = customTheme["backdrop-sepia"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; }
            };
    ...
    [
        ...
        val => {
            var _a;
            const legalConfig = Object.assign(Object.assign(Object.assign({}, propertyMap.get('background-attachment')), propertyMap.get('background-repeat')), { 'transparent': 'bg-transparent', 'currentColor': 'bg-current', 'currentcolor': 'bg-current', 'none': 'bg-none', 'bottom': 'bg-bottom', 'center': 'bg-center', 'left': 'bg-left', 'left bottom': 'bg-left-bottom', 'left top': 'bg-left-top', 'right': 'bg-right', 'right bottom': 'bg-right-bottom', 'right top': 'bg-right-top', 'top': 'bg-top', 'auto': 'bg-auto', 'cover': 'bg-cover', 'contain': 'bg-contain' });
            return (_a = legalConfig[val]) !== null && _a !== void 0 ? _a : `bg-[${getCustomVal(val)}]`;
        }
    ],
    [
    ...
    [
        'background-color',
        val => { var _a; return ((_a = { 'transparent': 'bg-transparent', 'currentColor': 'bg-current', 'currentcolor': 'bg-current' }[val]) !== null && _a !== void 0 ? _a : (isColor(val, true) ? `bg-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'background-image',
        val => { var _a; return ((_a = { 'none': 'bg-none' }[val]) !== null && _a !== void 0 ? _a : `bg-[${getCustomVal(val)}]`); }
    ],
    [
        'background-origin',
        {
    ...
    [
        ...
        val => {
            ...
            const vals = val.split(' ').filter(v => v !== '').map(v => { var _a, _b, _c; return (isUnit(v) || isColor(v)) ? ((_b = (_a = { 'transparent': 'border-transparent', 'currentColor': 'border-current', 'currentcolor': 'border-current' }[val]) !== null && _a !== void 0 ? _a : propertyMap.get('border-style')[v]) !== null && _b !== void 0 ? _b : `border-[${v}]`) : ((_c = propertyMap.get('border-style')[v]) !== null && _c !== void 0 ? _c : ''); }).filter(v => v !== '').join(' ');
            return vals;
        }
    ],
    [
    ...
    [
        ...
        val => { var _a; return ((_a = { '0': 'rounded-bl-none', '0px': 'rounded-bl-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-bl${((useAllDefaultValues && getBorderRadiusDefaultVal(val)) || `-[${getCustomVal(val)}]`).replace(/null$/, '')}` : '')); }
    ],
    [
        'border-bottom-right-radius',
        val => { var _a; return ((_a = { '0': 'rounded-br-none', '0px': 'rounded-br-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-br${((useAllDefaultValues && getBorderRadiusDefaultVal(val)) || `-[${getCustomVal(val)}]`).replace(/null$/, '')}` : '')); }
    ],
    [
        'border-bottom-style',
    ...
    [
        ...
        val => { var _a; return ((_a = { '0': 'rounded-tl-none', '0px': 'rounded-tl-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-tl${((useAllDefaultValues && getBorderRadiusDefaultVal(val)) || `-[${getCustomVal(val)}]`).replace(/null$/, '')}` : '')); }
    ],
    [
        'border-top-right-radius',
        val => { var _a; return ((_a = { '0': 'rounded-tr-none', '0px': 'rounded-tr-none' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `rounded-tr${((useAllDefaultValues && getBorderRadiusDefaultVal(val)) || `-[${getCustomVal(val)}]`).replace(/null$/, '')}` : '')); }
    ],
    [
        'border-top-style',
    ...
    [
        'color',
        val => { var _a; return ((_a = { 'transparent': 'text-transparent', 'currentColor': 'text-current', 'currentcolor': 'text-current' }[val]) !== null && _a !== void 0 ? _a : (isColor(val, true) ? `text-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'color-scheme',
    ...
    [
        'column-gap',
        val => { var _a; return ((_a = { '0': 'gap-x-0' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `gap-x-[${val}]` : '')); }
    ],
    [
        'column-rule',
    ...
    [
        'fill',
        val => { var _a; return ((_a = { 'currentColor': 'fill-current', 'currentcolor': 'fill-current' }[val]) !== null && _a !== void 0 ? _a : (isColor(val, true) ? `fill-[${getCustomVal(val)}]` : '')); }
    ],
    [
        'filter',
        val => {
            ...
            const filterValConfig = {
                blur: (v) => { var _a, _b; return `blur-${(_b = (_a = customTheme["blur"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                brightness: (v) => { var _a, _b; return `brightness-${(_b = (_a = customTheme["brightness"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                contrast: (v) => { var _a, _b; return `contrast-${(_b = (_a = customTheme["contrast"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                grayscale: (v) => { var _a, _b; return `grayscale-${(_b = (_a = customTheme["grayscale"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                'hue-rotate': (v) => {
                    var _a, _b;
                    const t = hasNegative(v);
                    return `${t[0]}hue-rotate-${(_b = (_a = customTheme["grayscale"]) === null || _a === void 0 ? void 0 : _a[t[1]]) !== null && _b !== void 0 ? _b : `[${t[1]}]`}`;
                },
                invert: (v) => { var _a, _b; return `invert-${(_b = (_a = customTheme["invert"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                saturate: (v) => { var _a, _b; return `saturate-${(_b = (_a = customTheme["saturate"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; },
                sepia: (v) => { var _a, _b; return `sepia-${(_b = (_a = customTheme["sepia"]) === null || _a === void 0 ? void 0 : _a[v]) !== null && _b !== void 0 ? _b : `[${v}]`}`; }
            };
            const vals = getCustomVal(val).replace(/\(.+?\)/g, v => v.replace(/_/g, '')).split(')_').map(v => `${v})`);
            vals[vals.length - 1] = vals[vals.length - 1].slice(0, -1);
            let canUse = true;
            const res = vals.map(v => {
                ...
                pipeV = pipeV.length > 0 ? pipeV : v.replace(/^([a-zA-Z0-9_-]+)\((.+?)\)$/, (r, k, v) => {
                    var _a, _b;
                    canUsePipeV = true;
                    return (_b = (_a = filterValConfig[k]) === null || _a === void 0 ? void 0 : _a.call(filterValConfig, v)) !== null && _b !== void 0 ? _b : (canUse = false);
                });
                return canUsePipeV ? pipeV : '';
            });
    ...
    [
        'flex',
        val => { var _a; return ((_a = { '1 1 0%': 'flex-1', '1 1 auto': 'flex-auto', '0 1 auto': 'flex-initial', 'none': 'flex-none' }[val]) !== null && _a !== void 0 ? _a : `flex-[${getCustomVal(val)}]`); }
    ],
    [
        'flex-basis',
    ...
    [
        'flex-grow',
        val => { var _a; return ((isUnit(val) ? ((_a = { '0': 'flex-grow-0', '1': 'flex-grow' }[val]) !== null && _a !== void 0 ? _a : `flex-grow-[${val}]`) : '')); }
    ],
    [
        'flex-shrink',
        val => { var _a; return ((isUnit(val) ? ((_a = { '0': 'flex-shrink-0', '1': 'flex-shrink' }[val]) !== null && _a !== void 0 ? _a : `flex-shrink-[${val}]`) : '')); }
    ],
    [
        'flex-wrap',
        {
    ...
    [
        'gap',
        val => { var _a; return ((_a = { '0': 'gap-0' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `gap-[${val}]` : '')); }
    ],
    [
        'grid',
    ...
    [
        'grid-row-gap',
        val => { var _a; return ((_a = { '0': 'gap-y-0' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `gap-y-[${val}]` : '')); }
    ],
    [
        'grid-row-start',
        val => {
    ...
    [
        'letter-spacing',
        val => { var _a; return ((_a = { '-0.05em': 'tracking-tighter', '-0.025em': 'tracking-tight', '0em': 'tracking-normal', '0.025em': 'tracking-wide', '0.05em': 'tracking-wider', '0.1em': 'tracking-widest' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `tracking-[${val}]` : '')); }
    ],
    [
        'line-height',
        val => { var _a; return ((_a = { '1': 'leading-none', '2': 'leading-loose', '1.25': 'leading-tight', '1.375': 'leading-snug', '1.5': 'leading-normal', '1.625': 'leading-relaxed' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `leading-[${val}]` : '')); }
    ],
    [
        'list-style',
    ...
    [
        ...
        val => {
            const getPipeVal = (val) => {
                ...
                if (useAllDefaultValues) {
                    vals = vals.map(v => { var _a; return (_a = getRemDefaultVal(v)) !== null && _a !== void 0 ? _a : `[${v}]`; });
                }
                else {
                    vals = vals.map(v => `[${v}]`);
                }
    ...
    [
        ...
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mb-0', '0px': 'mb-0', 'auto': 'mb-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mb-${(useAllDefaultValues && getRemDefaultVal(t[1])) || `[${t[1]}]`}` : '');
        }
    ],
    [
        'margin-left',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'ml-0', '0px': 'ml-0', 'auto': 'ml-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}ml-${(useAllDefaultValues && getRemDefaultVal(t[1])) || `[${t[1]}]`}` : '');
        }
    ],
    [
        'margin-right',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mr-0', '0px': 'mr-0', 'auto': 'mr-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mr-${(useAllDefaultValues && getRemDefaultVal(t[1])) || `[${t[1]}]`}` : '');
        }
    ],
    [
        'margin-top',
        val => {
            var _a;
            const t = hasNegative(val);
            return (_a = { '0': 'mt-0', '0px': 'mt-0', 'auto': 'mt-auto' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `${t[0]}mt-${(useAllDefaultValues && getRemDefaultVal(t[1])) || `[${t[1]}]`}` : '');
        }
    ],
    [
        'mask',
    ...
    [
        'max-height',
        val => { var _a; return (isUnit(val) ? ((_a = { "0px": "max-h-0", "100%": "max-h-full", "100vh": "max-h-screen" }[val]) !== null && _a !== void 0 ? _a : `max-h-[${val}]`) : ''); }
    ],
    [
        'max-width',
        val => { var _a; return (isUnit(val) ? ((_a = { "none": "max-w-none", "100%": "max-w-full", "min-content": "max-w-min", "max-content": "max-w-max" }[val]) !== null && _a !== void 0 ? _a : `max-w-[${val}]`) : ''); }
    ],
    [
        'min-height',
        val => { var _a; return (isUnit(val) ? ((_a = { "0px": "min-h-0", "100%": "min-h-full", "100vh": "min-h-screen" }[val]) !== null && _a !== void 0 ? _a : `min-h-[${val}]`) : ''); }
    ],
    [
        'min-width',
        val => { var _a; return (isUnit(val) ? ((_a = { "0px": "min-w-0", "100%": "min-w-full", "min-content": "min-w-min", "max-content": "min-w-max" }[val]) !== null && _a !== void 0 ? _a : `min-w-[${val}]`) : ''); }
    ],
    [
        'mix-blend-mode',
        {
    ...
    [
        'opacity',
        val => { var _a; return ((_a = { '0': 'opacity-0', '1': 'opacity-100', '0.05': 'opacity-5', '0.1': 'opacity-10', '0.2': 'opacity-20', '0.25': 'opacity-25', '0.3': 'opacity-30', '0.4': 'opacity-40', '0.5': 'opacity-50', '0.6': 'opacity-60', '0.7': 'opacity-70', '0.75': 'opacity-75', '0.8': 'opacity-80', '0.9': 'opacity-90', '0.95': 'opacity-95' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `opacity-[${val}]` : '')); }
    ],
    [
        'order',
        val => { var _a; return ((_a = { '0': 'order-none', '1': 'order-1', '2': 'order-2', '3': 'order-3', '4': 'order-4', '5': 'order-5', '6': 'order-6', '7': 'order-7', '8': 'order-8', '9': 'order-9', '10': 'order-10', '11': 'order-11', '12': 'order-12', '9999': 'order-last', '-9999': 'order-first' }[val]) !== null && _a !== void 0 ? _a : (isUnit(val) ? `order-[${val}]` : '')); }
    ],
    [
        'outline',
    ...
    [
        'overflow-wrap',
        val => { var _a; return ((_a = { 'break-word': 'break-words' }[val]) !== null && _a !== void 0 ? _a : `[overflow-wrap:${getCustomVal(val)}]`); }
    ],
    [
        'overflow-x',
        {
    ...
    [
        'padding-bottom',
        val => { var _a; return ((_a = { '0': 'pb-0', '0px': 'pb-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pb-${(useAllDefaultValues && getRemDefaultVal(val)) || `[${val}]`}` : ''))); }
    ],
    [
        'padding-left',
        val => { var _a; return ((_a = { '0': 'pl-0', '0px': 'pl-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pl-${(useAllDefaultValues && getRemDefaultVal(val)) || `[${val}]`}` : ''))); }
    ],
    [
        'padding-right',
        val => { var _a; return ((_a = { '0': 'pr-0', '0px': 'pr-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pr-${(useAllDefaultValues && getRemDefaultVal(val)) || `[${val}]`}` : ''))); }
    ],
    [
        'padding-top',
        val => { var _a; return ((_a = { '0': 'pt-0', '0px': 'pt-0' }[val]) !== null && _a !== void 0 ? _a : ((isUnit(val) ? `pt-${(useAllDefaultValues && getRemDefaultVal(val)) || `[${val}]`}` : ''))); }
    ],
    [
        'page-break-after',
        {
    ...
    [
        ...
        val => {
            ...
            return ((_a = {
                ...
                currentcolor: 'stroke-current'
            }[val]) !== null && _a !== void 0 ? _a : (isColor(val, true) ? `stroke-[${getCustomVal(val)}]` : ''));
        }
    ],
    [
        'stroke-width',
    ...
    [
        ...
        (val) => {
            ...
            const transformValConfig = {
                ...
                scaleX: (v) => { var _a; return `scale-x-${((_a = customTheme.scale) === null || _a === void 0 ? void 0 : _a[v]) || (useAllDefaultValues && scaleDefaultVs[v]) || `[${v}]`}`; },
                scaleY: (v) => { var _a; return `scale-y-${((_a = customTheme.scale) === null || _a === void 0 ? void 0 : _a[v]) || (useAllDefaultValues && scaleDefaultVs[v]) || `[${v}]`}`; },
                rotate: (v) => {
                    var _a, _b;
                    const vs = v.split(',');
                    if (vs.length > 1) {
            ...
            const res = vals.map(v => {
                ...
                const pipeV = v.replace(/^([a-zA-Z0-9_-]+)\((.+?)\)$/, (r, k, v) => {
                    var _a, _b;
                    canUsePipeV = true;
                    const tmpRes = (_b = (_a = transformValConfig[k]) === null || _a === void 0 ? void 0 : _a.call(transformValConfig, v)) !== null && _b !== void 0 ? _b : (canUse = false);
    ...
    const resultVals = cssCodeList.map(v => {
        ...
        if (val === 'initial' || val === 'inherit') {
            ...
            pipeVal = typeof pipe === 'function'
                ? (((_b = config.customTheme[key.trim()]) === null || _b === void 0 ? void 0 : _b[val]) || (config.useAllDefaultValues && ((_c = moreDefaultValuesMap[key.trim()]) === null || _c === void 0 ? void 0 : _c[val])) || pipe(val))
                : (((_d = config.customTheme[key.trim()]) === null || _d === void 0 ? void 0 : _d[val]) || (config.useAllDefaultValues && ((_e = moreDefaultValuesMap[key.trim()]) === null || _e === void 0 ? void 0 : _e[val])) || ((_f = pipe === null || pipe === void 0 ? void 0 : pipe[val]) !== null && _f !== void 0 ? _f : ''));
        }
        if (((_h = (_g = config.prefix) === null || _g === void 0 ? void 0 : _g.length) !== null && _h !== void 0 ? _h : 0) > 0) {
...
export const CssToTailwindTranslator = (code, config = defaultTranslatorConfig) => {
    ...
    useAllDefaultValues = (_a = config.useAllDefaultValues) !== null && _a !== void 0 ? _a : defaultTranslatorConfig.useAllDefaultValues;
    customTheme = (_b = config.customTheme) !== null && _b !== void 0 ? _b : defaultTranslatorConfig.customTheme;
    const dataArray = [];
    parsingCode(code).map(it => {
        if (typeof it.cssCode === 'string') {
            ...
            return it.cssCode.map(v => {
                ...
                const res = getResultCode(v, ((_a = customTheme.media) === null || _a === void 0 ? void 0 : _a[it.selectorName]) || (config.useAllDefaultValues && moreDefaultMediaVals[mediaName]) || `[${mediaName}]`, config);
                return res ? ({

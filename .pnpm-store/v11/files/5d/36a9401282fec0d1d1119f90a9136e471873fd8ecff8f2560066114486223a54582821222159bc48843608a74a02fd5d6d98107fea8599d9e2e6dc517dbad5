...
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/plugins/estree.mjs
function ec(e) {
...
function Is(e, t, r) {
	...
	switch (i.type) {
		...
		case "VariableDeclarator":
			...
			break;
		case "TSInstantiationExpression": if (o === "expression" && (n.type === "AwaitExpression" || n.type === "YieldExpression")) return !0;
	}
}
function Al(e, t) {
	let { key: r, parent: n } = e;
...
function Nr(e) {
	...
	switch (t.type) {
		...
		case "ConditionalExpression":
			...
			break;
		case "UnaryExpression": if (t.prefix && e.callParent(Nr)) return !0;
	}
	return !1;
}
function bl(e) {
...
function du(e, t) {
	...
	if (!q(n)) return !1;
	let { value: o } = n;
	return ot(ye(n), t).slice(1, -1) !== o || e.type === "TSMethodSignature" && o === "new" ? !1 : !!(!(r === "babel-ts" && e.type === "ClassProperty" || (r === "typescript" || r === "oxc-ts" || r === "yuku-ts") && e.type === "PropertyDefinition") && au(o) || (r === "babel" || r === "acorn" || r === "oxc" || r === "yuku" || r === "espree" || r === "meriyah" || r === "__babel_estree") && e.type !== "ImportAttribute" && Eu(o) && String(Number(o)) === o);
}
function Cu(e, t) {
...
function ga(e) {
	...
	switch (e.type) {
		case "GenericTypeAnnotation":
			t = e.typeParameters;
			break;
		case "TSTypeReference": t = e.typeArguments;
	}
	return t?.params;
}
...
`;
	...
	gm = ({ parser: e }) => e === "typescript" || e === "babel-ts" || e === "oxc-ts" || e === "yuku-ts";

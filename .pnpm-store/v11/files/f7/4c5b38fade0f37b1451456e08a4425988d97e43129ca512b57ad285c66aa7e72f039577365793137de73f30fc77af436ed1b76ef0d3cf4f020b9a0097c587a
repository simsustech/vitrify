...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BZkhU5rp.js"));
	try {
...
var init_prettier = __esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			...
			name: "markdown",
			load: () => import("./markdown-z6zLajvc.js"),
			...
			name: "typescript",
			load: () => import("./typescript-DCDD9Ptg.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-BZkhU5rp.js"),

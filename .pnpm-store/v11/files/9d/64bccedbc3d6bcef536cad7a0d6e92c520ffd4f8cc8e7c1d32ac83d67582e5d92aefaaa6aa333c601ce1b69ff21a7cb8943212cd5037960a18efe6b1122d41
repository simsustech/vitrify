...
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/plugins/yaml.mjs
function _o(t) {
...
function hs(t, e) {
	switch (t.type) {
		...
		case "document":
			...
			break;
		case "blockLiteral":
		case "blockFolded": t.chomping === "keep" ? e.value = t.value.split(`
...
function Zo(t) {
	switch (t.type) {
		...
		case "mappingValue":
			...
			break;
		case "mappingItem":
		case "flowMappingItem": Xe(t, "key", () => t.children[0]), Xe(t, "value", () => t.children[1]);
	}
	return t;
}
function ea(t, e, n) {

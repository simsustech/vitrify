...
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/plugins/acorn.mjs
function Ge(e, t) {
		...
		onEnter(h) {
			switch (ts(h, s, i), h.type) {
				...
				case "TemplateElement":
					if (r === "flow" || r === "hermes" || r === "espree" || r === "typescript" || r === "oxc-ts" || r === "yuku-ts") h.range = [w(h) + 1, I(h) - (h.tail ? 1 : 2)];
					break;
				...
				case "TupleTypeAnnotation":
					...
					break;
				case "ImportDeclaration": r === "hermes" && h.assertions && !h.attributes && (h.attributes = h.assertions, delete h.assertions);
			}
		},
		onLeave(h) {
			switch (h.type) {
				case "LogicalExpression": if (vi(h)) return st(h);
			}
		}
	}), e;
}
...
function Vi(e) {
	...
	let n = t === 3 ? e.allowReserved || "never" : !1, o = e.ecmaFeatures || {}, h = e.sourceType === "commonjs" || !!o.globalReturn;
...
function Cs(e, t, i, r, s, n, o) {
	...
	return typeof i == "number" && (c.start = i, c.end = r, c.range = [i, r]), typeof s == "object" && (c.loc = {
		start: s,
		end: n
	}), c;
}
...
var Bi, Me, Fi, ji, Ui, Gi, ct, Be, Wi, pt, ti, et, Mi, nt, qi, yt, Hi, gt, Fe, je, Ki, vt, Ji, Xi, _, O, L, Ke, a, R, zi, St, T, Ct, Qi, Yi, te, lt, ft, Zi, ue, be, We, dt, X, z, Je, Et, Xe, kt, Se, At, Q, he, Tt, Ce, xe, Qe, q, wt, It, Pt, A, M, P, tr, _e, d, Ye, ir, rr, oe, qe, Nt, B, F, k, ie, g, ar, ge, J, nr, Ee, ce, or, Vt, Ot, Dt, Mt, Bt, hr, pr, mt, Ft, jt, Ut, Gt, Wt, fr, qt, xt, me, Ue, f, ve, U, Jt, W, D, Ze, b, $t, Li, Ae, re, Rr, si, we, Ie, Mr, Br, Fr, ai, jr, ni, Ur, tt, ae, oi, Gr, Wr, Z, hi, Jr, pi, di, le, Yr, mi, u, yi, gi, Ne, at, rs, ss, as, ns, bi, os, Si, us, hs, Ei, ki, Ai, Le, Re, Pi, Ve, ls, Ni, ds, ys, ht, Oi, Ri, gs, $, ot, ut, _s, Es, Ts, ws;
//#endregion
__esmMin((() => {
	Bi = Object.create;
	...
	et = ct((Ns, $e) => {
		...
		function ri(e) {
			...
			let t = ii.get(e);
			if (!t) {
				let i = e.tokTypes, r = e.TokContext, s = e.TokenType, n = new r("<tag", !1), o = new r("</tag", !1), h = new r("<tag>...</tag>", !0, !0), c = {
					tc_oTag: n,
					tc_cTag: o,
					tc_expr: h
				}, l = {
				...
				l.jsxTagStart.updateContext = function() {
					...
					S === n && m === i.slash || S === o ? (this.context.pop(), this.exprAllowed = this.curContext() === h) : this.exprAllowed = !0;
				}, t = {
					tokContexts: c,
					tokTypes: l
				}, ii.set(e, t);
...
`) : y = String.fromCharCode(x), this.options.locations && (++this.curLine, this.lineStart = this.pos), y;
				...
				updateContext(p) {
					if (this.type == s.braceL) {
						...
						x == h ? this.context.push(o.b_expr) : x == l ? this.context.push(o.b_tmpl) : super.updateContext(p), this.exprAllowed = !0;
					} else if (this.type === s.slash && p === n.jsxTagStart) this.context.length -= 2, this.context.push(c), this.exprAllowed = !1;
...
`, r - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(R).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = a.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = t.sourceType === "module", this.strict = this.inModule || t.strict === !0 || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), this.pos === 0 && t.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(this.options.sourceType === "commonjs" ? z : X), this.regexpState = null, this.privateNameStack = [];
	...
	d.isUsingKeyword = function(e, t) {
		...
		if (t && !e && l === "of") {
			...
			if (r = r + m[0].length, this.input.charCodeAt(r) !== 61 || (h = this.input.charCodeAt(r + 1)) === 61 || h === 62) return !1;
		}
		return !0;
	};
	...
	d.parseForStatement = function(e) {
		...
		if (h) {
			...
			return this.next(), h === "await using" && (this.canAwait || this.raise(this.start, "Await using cannot appear outside of async function"), this.next()), this.parseVar(c, !0, h), this.finishNode(c, "VariableDeclaration"), this.parseForAfterInit(e, c, t);
		}
		var l = this.containsEsc, m = new _e(), S = this.start, E = t > -1 ? this.parseExprSubscripts(m, "await") : this.parseExpression(!0, m);
	...
	d.parseClassElement = function(e) {
		...
		var t = this.options.ecmaVersion, i = this.startNode(), r = "", s = !1, n = !1, o = "method", h = !1;
		if (this.eatContextual("static")) {
			if (t >= 13 && this.eat(a.braceL)) return this.parseClassStaticBlock(i), i;
			this.isClassElementNameStart() || this.type === a.star ? h = !0 : r = "static";
		}
		if (i.static = h, !r && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === a.star) && !this.canInsertSemicolon() ? n = !0 : r = "async"), !r && (t >= 9 || !n) && this.eat(a.star) && (s = !0), !r && !n && !s) {
			var c = this.value;
	...
	ie.braceIsBlock = function(e) {
		...
		return t === k.f_expr || t === k.f_stat ? !0 : e === a.colon && (t === k.b_stat || t === k.b_expr) ? !t.isExpr : e === a._return || e === a.name && this.exprAllowed ? R.test(this.input.slice(this.lastTokEnd, this.start)) : e === a._else || e === a.semi || e === a.eof || e === a.parenR || e === a.arrow ? !0 : e === a.braceL ? t === k.b_stat : e === a._var || e === a._const || e === a.name ? !1 : !this.exprAllowed;
	};
	...
	a._function.updateContext = a._class.updateContext = function(e) {
		e.beforeExpr && e !== a._else && !(e === a.semi && this.curContext() !== k.p_stat) && !(e === a._return && R.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === a.colon || e === a.braceL) && this.curContext() === k.b_stat) ? this.context.push(k.f_expr) : this.context.push(k.f_stat), this.exprAllowed = !1;
	};
	...
	g.parseExprOp = function(e, t, i, r, s) {
		...
		if (n != null && (!s || this.type !== a._in) && n > r) {
			...
			var c = this.value;
			this.next();
			var l = this.start, m = this.startLoc, S = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, s), l, m, n, s), E = this.buildBinary(t, i, e, S, c, o || h);
	...
	g.parseMaybeUnary = function(e, t, i, r) {
		...
		if (this.isContextual("await") && this.canAwait) o = this.parseAwait(r), t = !0;
			...
			h.operator = this.value, h.prefix = !0, this.next(), h.argument = this.parseMaybeUnary(null, !0, c, r), this.checkExpressionErrors(e, !0), c ? this.checkLValSimple(h.argument) : this.strict && h.operator === "delete" && Lt(h.argument) ? this.raiseRecoverable(h.start, "Deleting local variable in strict mode") : h.operator === "delete" && He(h.argument) ? this.raiseRecoverable(h.start, "Private fields can not be deleted") : t = !0, o = this.finishNode(h, c ? "UpdateExpression" : "UnaryExpression");
	...
	g.parseSubscript = function(e, t, i, r, s, n, o) {
		...
		if (l || c && this.type !== a.parenL && this.type !== a.backQuote || this.eat(a.dot)) {
			...
			this.checkExpressionErrors(S, !0), this.yieldPos = E || this.yieldPos, this.awaitPos = p || this.awaitPos, this.awaitIdentPos = x || this.awaitIdentPos;
	...
	g.parseExprAtom = function(e, t, i) {
		...
		switch (this.type) {
			...
			case a.name:
				var n = this.start, o = this.startLoc, h = this.containsEsc, c = this.parseIdent(!1);
				if (this.options.ecmaVersion >= 8 && !h && c.name === "async" && !this.canInsertSemicolon() && this.eat(a._function)) return this.overrideContext(k.f_expr), this.parseFunction(this.startNodeAt(n, o), 0, !1, !0, t);
				if (s && !this.canInsertSemicolon()) {
					if (this.eat(a.arrow)) return this.parseArrowExpression(this.startNodeAt(n, o), [c], !1, t);
					if (this.options.ecmaVersion >= 8 && c.name === "async" && this.type === a.name && !h && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return c = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(a.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, o), [c], !0, t);
				}
				return c;
			case a.regexp:
				var l = this.value;
			...
			case a.braceL: return this.overrideContext(k.b_expr), this.parseObj(!1, e);
	...
	g.parseParenAndDistinguishExpression = function(e, t) {
		...
		if (this.options.ecmaVersion >= 6) {
			this.next();
			var o = this.start, h = this.startLoc, c = [], l = !0, m = !1, S = new _e(), E = this.yieldPos, p = this.awaitPos, x;
			for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR;) if (l ? l = !1 : this.expect(a.comma), n && this.afterTrailingComma(a.parenR, !0)) {
				...
				break;
			} else c.push(this.parseMaybeAssign(!1, S, this.parseParenItem));
			var y = this.lastTokEnd, v = this.lastTokEndLoc;
			if (this.expect(a.parenR), e && this.shouldParseArrow(c) && this.eat(a.arrow)) return this.checkPatternErrors(S, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = E, this.awaitPos = p, this.parseParenArrowList(i, r, c, t);
			(!c.length || m) && this.unexpected(this.lastTokStart), x && this.unexpected(x), this.checkExpressionErrors(S, !0), this.yieldPos = E || this.yieldPos, this.awaitPos = p || this.awaitPos, c.length > 1 ? (s = this.startNodeAt(o, h), s.expressions = c, this.finishNodeAt(s, "SequenceExpression", y, v)) : s = c[0];
...
`),
	...
	g.parseProperty = function(e, t) {
		...
		return this.parsePropertyName(i), !e && !h && this.options.ecmaVersion >= 8 && !r && this.isAsyncProp(i) ? (s = !0, r = this.options.ecmaVersion >= 9 && this.eat(a.star), this.parsePropertyName(i)) : s = !1, this.parsePropertyValue(i, e, r, s, n, o, t, h), this.finishNode(i, "Property");
	};
	...
	g.parseMethod = function(e, t, i) {
		...
		return this.initFunction(r), this.options.ecmaVersion >= 6 && (r.generator = e), this.options.ecmaVersion >= 8 && (r.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(ze(t, r.generator) | Se | (i ? At : 0)), this.expect(a.parenL), r.params = this.parseBindingList(a.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(r, !1, !0, !1), this.yieldPos = s, this.awaitPos = n, this.awaitIdentPos = o, this.finishNode(r, "FunctionExpression");
	};
	...
	g.parseFunctionBody = function(e, t, i, r) {
		...
		if (s) e.body = this.parseMaybeAssign(r), e.expression = !0, this.checkParams(e, !1);
			...
			var c = this.labels;
			this.labels = [], o && (this.strict = !0), this.checkParams(e, !n && !o && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, Pt), e.body = this.parseBlock(!1, void 0, o && !n), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = c;
		}
		this.exitScope();
	};
...
`;
	...
	ds = () => (Ni ?? (Ni = A.extend((0, Li.default)())), Ni);
	ys = Le(xs);
	ht = {};
	Be(ht, { espree: () => Ts });
	Oi = pt(et(), 1);
	...
	ut = () => (e) => {
		...
		return e.acornJsx && Object.assign(t, e.acornJsx.tokTypes), class extends e {
			constructor(r, s) {
				...
				let n = r.sourceType, o = Vi(r), h = o.ecmaFeatures || {}, l = {
					originalSourceType: n || o.sourceType,
					tokens: null,
					comments: o.comment === !0 ? [] : null,
					impliedStrict: h.impliedStrict === !0 && o.ecmaVersion >= 5,

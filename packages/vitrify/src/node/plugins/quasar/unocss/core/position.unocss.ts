...
const shortcuts: UserShortcuts<QuasarTheme> = [
  [
    /^fixed-full$/,
    ([, c], { theme }) => `fixed top-[0] right-[0] bottom-[0] left-[0]`
  ],
  ...
  [
    /^fixed-bottom$/,
    ([, c], { theme }) => `fixed right-[0] bottom-[0] left-[0]`
  ],
  ...
  [
    /^absolute-left$/,
    ([, c], { theme }) => `absolute top-[0] bottom-[0] left-[0]`
  ],

  [
    /^absolute-right$/,
    ([, c], { theme }) => `absolute top-[0] right-[0] bottom-[0]`
  ],

  [
    /^absolute-top$/,
    ([, c], { theme }) => `absolute top-[0] left-[0] right-[0]`
  ],
  ...
  [
    ...
    ([, c], { theme }) => `absolute bottom-[0] left-[0]`
  ],
  ...
  [
    /^q-position-engine$/,
    ([, c], { theme }) => `!mt-[var(--q-pe-top, !0)] !ml-[var(--q-pe-left, !0)]`
  ]
]

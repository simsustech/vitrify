...
const shortcuts: UserShortcuts<QuasarTheme> = [
  ...
  [
    /^q-slider__track$/,
    ([, c], { theme }) =>
      `bg-[rgba(0,_0,_0,_0.1)] rounded-[4px] [width:inherit] [height:inherit]`
  ],
  ...
  [
    /^q-slider__markers$/,
    ([, c], { theme }) =>
      `text-[rgba(0,_0,_0,_0.3)] [border-radius:inherit] w-full h-full`
  ],

  [
    /^q-slider__markers:after$/,
    ([, c], { theme }) => `content-[''] absolute bg-current`
  ],

  [
    /^q-slider__markers--h$/,
    ([, c], { theme }) =>
      `bg-[repeating-linear-gradient(_to_right,_currentColor,_currentColor_2px,_rgba(255,_255,_255,_0)_0,_rgba(255,_255,_255,_0)_)]`
  ],

  [
    /^q-slider__markers--h:after$/,
    ([, c], { theme }) => `h-full w-[2px] top-[0] right-[0]`
  ],

  [
    /^q-slider__markers--v$/,
    ([, c], { theme }) =>
      `bg-[repeating-linear-gradient(_to_bottom,_currentColor,_currentColor_2px,_rgba(255,_255,_255,_0)_0,_rgba(255,_255,_255,_0)_)]`
  ],

  [
    /^q-slider__markers--v:after$/,
    ([, c], { theme }) => `w-full h-[2px] left-[0] bottom-[0]`
  ],
  ...
  [
    /^q-slider__thumb$/,
    ([, c], { theme }) =>
      `text-primary outline-[0] [transition:transform_0.18s_ease-out,_fill_0.18s_ease-out,_stroke_0.18s_ease-out] z-1`
  ],

  [/^q-slider__thumb.q-slider--focus$/, ([, c], { theme }) => `!opacity-100`],
  ...
  [
    /^q-slider__pin$/,
    ([, c], { theme }) =>
      `opacity-0 whitespace-nowrap [transition:opacity_0.28s_ease-out] delay-[140ms]`
  ],

  [
    /^q-slider__pin:before$/,
    ([, c], { theme }) => `content-[''] w-[0] h-[0] absolute`
  ],

  [
    /^q-slider__pin--h:before$/,
    ([, c], { theme }) =>
      `[border-left:6px_solid_transparent] [border-right:6px_solid_transparent] left-2/4 -translate-x-1/2`
  ],

  [/^q-slider__pin--h-standard$/, ([, c], { theme }) => `bottom-full`],

  [
    /^q-slider__pin--h-standard:before$/,
    ([, c], { theme }) => `bottom-[2px] [border-top:6px_solid_currentColor]`
  ],

  [/^q-slider__pin--h-switched$/, ([, c], { theme }) => `top-full`],

  [
    /^q-slider__pin--h-switched:before$/,
    ([, c], { theme }) => `top-[2px] [border-bottom:6px_solid_currentColor]`
  ],

  [/^q-slider__pin--v$/, ([, c], { theme }) => `top-[0]`],

  [
    /^q-slider__pin--v:before$/,
    ([, c], { theme }) =>
      `top-2/4 -translate-y-1/2 [border-top:6px_solid_transparent] [border-bottom:6px_solid_transparent]`
  ],

  [/^q-slider__pin--v-standard$/, ([, c], { theme }) => `left-full`],

  [
    /^q-slider__pin--v-standard:before$/,
    ([, c], { theme }) => `left-[2px] [border-right:6px_solid_currentColor]`
  ],

  [/^q-slider__pin--v-switched$/, ([, c], { theme }) => `right-full`],

  [
    /^q-slider__pin--v-switched:before$/,
    ([, c], { theme }) => `right-[2px] [border-left:6px_solid_currentColor]`
  ],

  [/^q-slider__label$/, ([, c], { theme }) => `whitespace-nowrap absolute z-1`],
  ...
  [
    /^q-slider--active.q-slider--label$/,
    ([, c], { theme }) => `[&_.q-slider\_\_thumb-shape]:(!scale-0)`
  ],

  [
    /^q-slider--label.q-slider--active$/,
    ([, c], { theme }) => `[&_.q-slider\_\_pin]:(opacity-100)`
  ],
  ...
  [
    /^q-slider--label.q-slider--label-always$/,
    ([, c], { theme }) => `[&_.q-slider\_\_pin]:(opacity-100)`
  ],

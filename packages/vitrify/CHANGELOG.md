...
- 2cc4b40: fix: ship working `vitrify/client` TypeScript declarations
...
- b8ad6b6: feat: add `chunks` code splitting config and fix rolldown chunk duplication
...
- 689fa08: fix: derive `__BASE_URL__` from the effective base config
...
- f355c63: fix: inline CSS in SSG builds with a custom base URL
...
- 2f7fa77: chore: update dependencies
...
- 897e319: chore: update dependencies
...
- 9bfebdd: chore: update dependencies
- e981aac: chore: update dependencies
